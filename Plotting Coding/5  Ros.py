...
df1 = pd.read_excel(file_path, sheet_name=' overline{R^{o}_{s}}')
...
# Heatmap
# =========================================================
im = ax.imshow(data, aspect='auto', cmap='RdYlBu_r', interpolation='bicubic', vmin=0.9, vmax=1)
...
cbar.set_label(r'$\overline{R^{o}_{s}}$', rotation=90)
# =========================================================
# Tight Layout
# =========================================================
plt.tight_layout()
...
# Save
# =========================================================
plt.savefig(r'F:\0001Research\01 My Papers\2. Second paper\New Plotting Code\RetrievalPhase\MaximumConfiguration\Ros.pdf', bbox_inches='tight', pad_inches=0)
