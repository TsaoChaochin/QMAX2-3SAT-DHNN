...
df = pd.read_excel(file_path, sheet_name='STD_{MAPE_Learn}')
# =========================================================
# Construct Matrix
# =========================================================
...
cbar.set_label(r'$\mathrm{STD}_{\mathrm{MAPE}_\mathrm{Learn}}$')
# =========================================================
# Remove Borders
# =========================================================
...
# =========================================================
# 'STD_{MAE_Learn}' 'STD_{RMSE_Learn}' 'STD_{MAPE_Learn}'
plt.savefig(r'F:\0001Research\01 My Papers\2. Second paper\New Plotting Code\LearningPhase\STD_{MAPE_Learn}_Heatmap.pdf')
